...
class ContentDesign1:
    ...
    def render(self) -> Image.Image:
        ...
        draw.text((padding_x + brand_w_guizot + 10, padding_y), "labs", fill=text_dark, font=brand_font_reg)

        # --- Separator Line ---
        draw.line([padding_x, padding_y + 100, self.width - padding_x, padding_y + 100], fill=text_dark, width=1)
