"""
Instagram Feed — CTA Template — Design 1
...
class CtaDesign1:
    ...
    def render(self) -> Image.Image:
        ...
        subtitle_font = load_font("poppins_regular", 34)
        ...
        cta_font = load_font("poppins_bold", 68)
        cta_lines = wrap_text(cta_text, cta_font, text_area_width)
        cta_height = get_text_height(cta_lines, cta_font, line_spacing=8)

        # --- Buttons ---
        buttons = ["Share", "Save"]
        btn_font = load_font("poppins_regular", 26)
        btn_padding_x = 36
        btn_padding_y = 12
        btn_spacing = 20
        btn_radius = 28
        ...
        gap_subtitle_cta = 24 if subtitle_text else 0
        gap_cta_btn = 40
        ...
        handle_font = load_font("poppins_regular", 28)
