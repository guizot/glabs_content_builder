"""
Instagram Feed (Square) — Hook Template — Design 1
...
class HookDesign1:
    ...
    def render(self) -> Image.Image:
        ...
        article_img = self._load_article_image(
            ...
            max_height=int(available_height - text_height - 30)  # leave room for text + gap
        )
        ...
        if article_img:
            ...
            text_y = img_y + article_img.height + 24
        else:
